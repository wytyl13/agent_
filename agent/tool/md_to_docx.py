...
def method_2_markdown_docx_custom(md_file: str, output_file: str) -> bool:
    ...
    try:
        ...
        # Set default font functions - 修改默认字体大小为16
        def set_font_style(run, font_name="宋体", font_size=16, color=None):
        ...
        def set_paragraph_font(paragraph, font_name="宋体", font_size=16, color=None):
        ...
        for line in lines:
            ...
            if line_stripped.startswith('# '):
                ...
                # 三级标题：自动编号，宋体18号字体，蓝色，添加 | 分隔符
                h3_counter += 1
                heading_text = f"{h3_counter:02d} | {line_stripped[4:]}"  # 01 | 标题格式
            ...
            # Lists
                ...
                set_paragraph_font(p, "宋体", 16)  # 正文16号字体
                ...
                if not success:
                    ...
                    if match:
                        ...
                        try:
                            ...
                            pass  # 如果设置颜色失败，忽略
            # Regular paragraphs - 正文宋体16号字体，跳过横线分割符
            else:
                # 跳过横线分割符（如 ---、___、***）
        ...
        print(f"   • 一级标题: 宋体 20pt 蓝色")
        print(f"   • 二级标题: 宋体 20pt 蓝色 (无编号)")
        print(f"   • 三级标题: 宋体 18pt 蓝色 + 自动编号 | 分隔符 (每个二级标题下从01开始)")
        print(f"   • 四级及以下标题: 宋体 15-16pt 蓝色")
        print(f"   • 正文: 宋体 16pt 黑色")
...
def convert_md_to_docx_custom(md_file: str, output_file: Optional[str] = None) -> bool:
    ...
    print("  • 一级标题: 宋体 20pt 蓝色")
    print("  • 二级标题: 宋体 20pt 蓝色 (无编号)")
    print("  • 三级标题: 宋体 18pt 蓝色 + 自动编号 | 分隔符 (每个二级标题下从01开始)")
    print("  • 四级标题: 宋体 16pt 蓝色")
    print("  • 正文内容: 宋体 16pt 黑色")
...
def main():
    ...
    if not args.input:
        ...
        print("  • 正文段落: 宋体 16pt 黑色")
        print("  • 列表项: 宋体 16pt 黑色")
